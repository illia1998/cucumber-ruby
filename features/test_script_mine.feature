Feature: Integration functional testing of Redmine user rights
  As a Redmine user
  I want to able to create projects, create issues, assign developers to issues, submit time and close issues and projects
  So I can be sure that development life cycle is correctly represented in Redmine

  Scenario: Project Admin creates a project and assigns a developer to it. Developer completes task and closes it.
    Given I am not logged in visitor

    When I register 'admin' user via Rednine 'UI'
    ...
    When I register 'developer user via Rednine "APT"
